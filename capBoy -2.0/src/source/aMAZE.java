...
public class aMAZE extends JPanel implements ActionListener {
    ...
    private final int CAP_ANIM_DELAY = -20;
    private final int CAPBOY_ANIM_COUNT = 4;
    private final int MAX_GHOSTS = 12;
    private final int CAPBOY_SPEED = 6;

    private int capAnimCount = CAP_ANIM_DELAY;
    private int capAnimDir = 1;
    private int capBoyAnimPos = 0;
    private int N_GHOSTS = 6;
    private int capsLeft, score;
    private int[] dx, dy;
    ...
    // 1 = left; 2 = top; 4 = right; 8 = bottom; 16 = point; can be added; (24)
    ...
    private void doAnim() {
        ...
        //DELAY **NOT WORKING**
        if (capAnimCount <= 0) {
            capAnimCount = CAP_ANIM_DELAY;
            capBoyAnimPos = capBoyAnimPos + capAnimDir;

            if (capBoyAnimPos == (CAPBOY_ANIM_COUNT - 1) || capBoyAnimPos == 0) {
                capAnimDir = -capAnimDir;
            }
        }
    }
    ...
    private void moveCapboy() {
        ...
        capboy_x = capboy_x + CAPBOY_SPEED * capboyd_x;
        capboy_y = capboy_y + CAPBOY_SPEED * capboyd_y;
    }
